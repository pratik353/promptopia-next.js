...
const Form = ({type,post,setPost,submitting,handleSubmit}) => {
  return (
    <section className='w-full max-h-full flex-start flex-col'>
      ...
      <p className='desc text-left max-w-md'>{type} and share amazing prompts with the world with and AI-powered platform</p>
      <form onSubmit={handleSubmit} className='mt-10 w-full amx-w-2xl flex flex-col gap-7 glassmorphism'>
        <label>
